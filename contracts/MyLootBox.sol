...
contract MyLootBox is ILootBox, Ownable, Pausable, ReentrancyGuard, MyFactory {
   ...
   *      sample settings
   * @param _proxyRegistryAddress The address of the Wyvern proxy registry  =====>> PROXY
   *                              On Rinkeby: "0xf57b2c51ded3a29e6891aba85459d600256cf317"  ===> a définir
   *                              On mainnet: "0xa5409ec958c83c3f309868babaca7c86dcb077c1"  ===> a définir
